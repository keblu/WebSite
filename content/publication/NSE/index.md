...
tags = ["Bootstrap", "GARCH", "HAC kernel", "numerical standard error (NSE)", "Monte Carlo", "Markov chain Monte Carlo (MCMC)", "spectral density", "Value-at-Risk precision"]

# Links (optional).
url_pdf = "https://www.degruyter.com/view/j/jtse.ahead-of-print/jtse-2017-0011/jtse-2017-0011.xml"
url_custom = [{name = "SSRN", url = "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2741587"}]
